  ...
  return (
    <div style={{ paddingTop: '80px' }}>
          ...
          <div className="car-detail-wrapper">
            ...
            <div className="car-detail-info">
              ...
              <h1 style={{
                ...
                marginBottom: '20px', lineHeight: 1.2, wordBreak: 'break-word'
              }}>
                {car.title}
              </h1>
              ...
              {car.engine && (
                <div style={{
                  padding: '16px', background: 'linear-gradient(135deg, #0a0a0a 0%, #1a1a2e 100%)',
                  color: '#fff', marginBottom: '20px', borderRadius: '12px'
                }}>
                  <p style={{ fontSize: '0.65rem', textTransform: 'uppercase', color: 'rgba(255,255,255,0.5)', marginBottom: '4px' }}>Engine</p>
                  <p style={{ fontSize: '1rem', fontWeight: '600' }}>{car.engine}</p>
                </div>
              )}
              ...
              <div className="specs-grid">
                {specs.map((spec, i) => (
                  <div key={i} style={{
                    ...
                    padding: '12px', background: '#f8f8f8', borderRadius: '10px'
                  }}>
                    <div style={{
                    ...
                    <div style={{ minWidth: 0, flex: 1 }}>
                      <p style={{ fontSize: '0.6rem', color: '#737373', textTransform: 'uppercase' }}>{spec.label}</p>
                      <p style={{
                        fontWeight: '600', color: '#0a0a0a', fontSize: '0.8rem',
              ...
              {car.description && (
                <div style={{ marginTop: '20px' }}>
                  <h3 style={{ fontSize: '0.8rem', fontWeight: '600', textTransform: 'uppercase', color: '#737373', marginBottom: '10px' }}>About This Vehicle</h3>
                  <p style={{ color: '#525252', lineHeight: 1.7, fontSize: '0.9rem' }}>{car.description}</p>
                </div>
              )}
              ...
              {car.features?.length > 0 && (
                <div style={{ marginTop: '20px' }}>
                  <h3 style={{ fontSize: '0.8rem', fontWeight: '600', textTransform: 'uppercase', color: '#737373', marginBottom: '10px' }}>Features</h3>
              ...
              <div style={{
                ...
                <p style={{ fontSize: '0.65rem', textTransform: 'uppercase', opacity: 0.8, marginBottom: '4px' }}>Interested?</p>
                <p style={{ fontSize: '1.1rem', fontWeight: '600', marginBottom: '16px' }}>Contact Us for Details</p>
                <div className="cta-buttons">
                  <button onClick={() => setShowInquiry(true)} style={{
                    display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px',
                    padding: '12px 16px', background: '#fff', color: '#c41e3a',
                    fontSize: '0.8rem', fontWeight: '600', border: 'none', borderRadius: '10px', cursor: 'pointer'
                  }}>
                    <MessageSquare size={16} />Inquiry
                  </button>
                  <a href="tel:03241344368" style={{
                    display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px',
                    padding: '12px 16px', background: 'rgba(255,255,255,0.15)', color: '#fff',
                    fontSize: '0.8rem', fontWeight: '600', border: '2px solid rgba(255,255,255,0.3)',
                    borderRadius: '10px', textDecoration: 'none'
                  }}>
                    <Phone size={16} />Call
                  </a>
                  <a href={`https://wa.me/923241344368?text=Hi! I am interested in ${encodeURIComponent(car.title)}.`}
                    target="_blank" rel="noopener noreferrer" style={{
                    display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px',
                    padding: '12px 16px', background: '#25D366', color: '#fff',
                    fontSize: '0.8rem', fontWeight: '600', border: 'none', borderRadius: '10px', textDecoration: 'none'
                  }}>
      ...
      {showInquiry && (
        <div style={{
          ...
          <div style={{
            ...
            maxHeight: '90vh', overflow: 'auto', borderRadius: '20px'
          }}>
            <div style={{
              ...
              <div>
                <p style={{ fontSize: '0.7rem', textTransform: 'uppercase', color: '#737373', marginBottom: '4px' }}>Inquiry For</p>
                <h3 style={{ fontSize: '1rem', fontWeight: '600' }}>{car.title}</h3>
              </div>
              <button onClick={() => setShowInquiry(false)} style={{
                width: '40px', height: '40px', display: 'flex', alignItems: 'center', justifyContent: 'center',
                border: '1px solid #e5e5e5', background: '#fff', cursor: 'pointer', borderRadius: '10px', fontSize: '1.5rem', color: '#737373'
              }}>×</button>
            </div>
            ...
            {submitted ? (
              <div style={{ padding: '50px 24px', textAlign: 'center' }}>
                <div style={{
                  width: '60px', height: '60px', margin: '0 auto 20px', background: '#dcfce7',
                  borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center'
                }}><Check size={30} color="#22c55e" /></div>
                <h3 style={{ fontSize: '1.3rem', fontWeight: '600', marginBottom: '10px' }}>Inquiry Sent!</h3>
                <p style={{ color: '#737373', marginBottom: '20px' }}>We'll get back to you soon.</p>
                <button onClick={() => { setShowInquiry(false); setSubmitted(false); }}
                  style={{ padding: '12px 28px', background: '#c41e3a', color: '#fff', border: 'none', borderRadius: '10px', fontWeight: '600', cursor: 'pointer' }}>Close</button>
              </div>
            ) : (
              <form onSubmit={handleSubmitInquiry} style={{ padding: '20px' }}>
                <div style={{ marginBottom: '14px' }}>
                  <label style={{ display: 'block', fontSize: '0.8rem', fontWeight: '600', marginBottom: '6px' }}>Your Name *</label>
                ...
                <div style={{ marginBottom: '14px' }}>
                  <label style={{ display: 'block', fontSize: '0.8rem', fontWeight: '600', marginBottom: '6px' }}>Phone</label>
                  <input type="tel" value={inquiryForm.phone}
                    onChange={(e) => setInquiryForm({ ...inquiryForm, phone: e.target.value })}
                    style={{ width: '100%', padding: '12px', border: '2px solid #e5e5e5', borderRadius: '10px', fontSize: '1rem' }} />
                </div>
                <div style={{ marginBottom: '20px' }}>
                  <label style={{ display: 'block', fontSize: '0.8rem', fontWeight: '600', marginBottom: '6px' }}>Message *</label>
                ...
                <button type="submit" disabled={submitting} style={{
                  width: '100%', padding: '14px', background: 'linear-gradient(135deg, #c41e3a 0%, #e63950 100%)',
      ...
      <style>{`
        ...
        .car-detail-gallery { width: 100%; }
        .car-detail-info { width: 100%; }
        .specs-grid {
          display: grid;
